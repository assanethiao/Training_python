...
class Application(object):
    ...
    def dessineResistance(self):
        ...
        self.can = Canvas(self.root, width=300, height=200, bg='light blue')
        ...
        self.ligne = []  # on mémorisera les trois lignes dans une liste
    ...
    def changeCouleurs(self):
        ...
        self.v1ch = self.entree.get()  # renvoie une chaîne
        try:
    ...
    def signaleErreur(self):
        ...
        self.root.after(5000, self.videEntree)  # après 1 seconde, effacer

    def videEntree(self):
        self.entree.configure(bg='white')  # rétablir le fond blanc
        self.entree.delete(0, len(self.v1ch))  # enlever les caractères présents
